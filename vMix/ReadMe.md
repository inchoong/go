...
快速全面认识vMix日期时间指令信息，日期、星期、上下午、时间、毫秒等等全部掌握！<br>
  <br>
H代表24小时制（0-24）{0:HH:mm:ss} 5:05:00<br>
HH代表24小时制（00-24）{0:HH:mm:ss} 05:05:00<br>
h代表12小时制（00-12）{0:h:mm:ss} 5:05:00<br>
hh代表12小时制（00-12）{0:hh:mm:ss} 05:05:00<br>
m代表分钟（1-60）<br>
mm代表分钟（01-60）<br>
s代表秒（1-60）<br>
ss代表秒（01-60）<br>
f代表十分之一秒 {0:HH:mm:ss.f} 20:15:00.0<br>
ff代表百分之一秒 {0:HH:mm:ss.ff} 20:15:00.00<br>
fff代表千分之一秒 {0:HH:mm:ss.fff} 20:15:00.000<br>
<br>
yy代表年份最后两位（23）<br>
yyyy代表年份四位数（2023）<br>
M代表一位数月份（1-12）<br>
MM代表两位数月份（01-12）<br>
MMM代表大写的月份（一月，十二月）<br>
d日期中的天数（1-31）<br>
dd日期中的天数（01-31）<br>
ddd代表星期几（一二三四五六七）<br>
dddd代表星期几（星期一，星期日）<br>
<br>
t代表显示 （上、下）<br>
tt代表显示 （上午、下午）<br>
<br>
距离23点还有多长时间 {0:23:00|HH:mm:ss} <br>
<br>
示例：<br>
24小时制：{0:H:mm:ss}<br>
12小时制：{0:tt h:mm:ss}<br>
毫秒计时：{0:ss.fff}<br>
日期格式1：{0:yyyy-M-d}<br>
日期格式2：{0:yyyy-M-d dddd tt}<br>
</qute>
